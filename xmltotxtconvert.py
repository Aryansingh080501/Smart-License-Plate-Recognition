...
# Example usage:
image_folder = "/Users/aryansingh/Desktop/Fall 2024/HTML&CSS Prep/License Plate Number Detection/archive/images/validation"  # Path to your images folder
annotation_folder = "/Users/aryansingh/Desktop/Fall 2024/HTML&CSS Prep/License Plate Number Detection/archive/annotations/validation"  # Path to your XML folder
label_folder = "/Users/aryansingh/Desktop/Fall 2024/HTML&CSS Prep/License Plate Number Detection/archive/label/validation"  # Path where YOLO annotation files will be saved
